...
namespace GoodFoodSystem.PresentationLayer
{
    public partial class EmployeeForm : Form
    {
        ...
        private EmployeeController employeeController;//referencing
        private Role.RoleType roleValue;
        //Add a public Boolean (bool) variable, employeeFormClosed, to indicate whether the form is closed ornot. Initialise this
        //variable to false
       public bool employeeFormClosed = false;
        #endregion

        #region Constructor
        public EmployeeForm(EmployeeController aController) //receive a parameter aController of type EmployeeController
        {
            InitializeComponent();
            //assign aController to the employeeController object
